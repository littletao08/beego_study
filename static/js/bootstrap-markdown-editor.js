...
!function (a) {
    ...
    var g = {
        init: function (g) {
            ...
            i.css({width: h.width}),o.css({width: h.width,height: h.height}), l.css({width: h.width, height: h.height, fontSize: h.fontSize}), m.css({
                width: h.width,
                height: h.height
            });
